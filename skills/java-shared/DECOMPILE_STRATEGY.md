...
```bash
# 方式 1: 从 GitHub 官方 release 下载（推荐）
curl -L -o {output_path}/cfr-0.152.jar "https://github.com/leibnitz27/cfr/releases/download/0.152/cfr-0.152.jar"
# 方式 2: 若 GitHub 不可达，使用镜像站
