...
| `deserialize_audit` | java-deserialization-audit | 反序列化漏洞审计报告 |
| `ssrf_audit` | java-ssrf-audit | SSRF 漏洞审计报告 |
| `expr_inject_audit` | java-expression-inject-audit | 表达式/模板注入审计报告 |
...
| java-ssrf-audit | `references/OUTPUT_TEMPLATE.md` | 1 个 |
| java-expression-inject-audit | `references/OUTPUT_TEMPLATE.md` | 1 个 |
